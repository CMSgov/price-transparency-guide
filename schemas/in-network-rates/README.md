...
* `percentage`: If applicable, the negotiated percentage value for a covered item or service from a particular in-network provider. Common arrangements for this type include percentage of billed contracts.
