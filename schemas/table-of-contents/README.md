...
**The Table of Contents File is a file that can be leveraged to significantly decrease file sizes of the required machine-readable files. Schema 2.0 requires using the Table of Contents file when multiple plans share negotiated rates across In-network files.**
...
The Reporting Structure object maps associated plans to their in-network and allowed amount files.
